...
OUTPUT_DIR='/mnt/vdb/dberezin/internvl/work_dirs/internvl_chat_v2_0/internvl2_8b_internlm2_7b_dynamic_res_2nd_finetune_lora_llm_full_mlp_lora_backbone'
...
torchrun \
  ...
  --run_name internvl2_8b_internlm2_7b_dynamic_res_2nd_finetune_lora_llm_full_mlp_lora_backbone_v6.0_8epochs \
