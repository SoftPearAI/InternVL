...
class DSElasticAgent(LocalElasticAgent):
    ...
    def __init__(
        ...
        super().__init__(spec, start_method, exit_barrier_timeout, logger_dir)
        self.ds_env = env
    ...
    def _start_workers(self, worker_group: WorkerGroup) -> Dict[int, Any]:
        ...
        # remove existing logger dir if this restart is due to a scaling event
        attempt_logger_dir = os.path.join(self._logger_dir, f"attempt_{restart_count}")
        shutil.rmtree(attempt_logger_dir, ignore_errors=True)
        os.makedirs(attempt_logger_dir)
